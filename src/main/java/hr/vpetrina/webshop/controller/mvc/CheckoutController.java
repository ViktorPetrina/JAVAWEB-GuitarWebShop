...
public class CheckoutController {
    ...
    public static final String CANCEL_URL_LOCAL = "http://localhost:8080/GuitarStore/paypal/payment/cancel";
    public static final String SUCCESS_URL_LOCAL = "http://localhost:8080/GuitarStore/paypal/payment/success";
